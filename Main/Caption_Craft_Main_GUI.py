...
captions = readTextFile("/temp/Caption Craft Project/Data/Flickr8k_text/Flickr8k.token.txt")
...
"""
IMG_PATH = "/temp/Caption Craft Project/Data/Flickr8k_Dataset/"
import cv2
import matplotlib.pyplot as plt
...
train_file_data = readTextFile("/temp/Caption Craft Project/Data/Flickr8k_text/Flickr_8k.trainImages.txt")
test_file_data = readTextFile("/temp/Caption Craft Project/Data/Flickr8k_text/Flickr_8k.testImages.txt")
...
"""with open("/temp/Caption Craft Project/Data/encoded_train_features.pkl","wb") as f:
...
"""with open("/temp/Caption Craft Project/Data/encoded_test_features.pkl","wb") as f:
...
encoded_train_features = "/temp/Caption Craft Project/Data/encoded_train_features.pkl"
encoded_test_features = "/temp/Caption Craft Project/Data/encoded_test_features.pkl"
...
f = open("/temp/Caption Craft Project/Data/glove.6B.50d.txt",encoding='utf8')
...
"""
model.save('/temp/Caption Craft Project/model_weights/model_test(100epochs)'+'.keras')
"""
...
def predict_caption(photo):
    model_load = load_model('/temp/Caption Craft Project/model_weights/model_test(100epochs).keras')
    in_text = "startseq"
...
def open_image():
    ...
    if file_path:
        ...
        if filesize > 5*1024*1024:
            messagebox.showerror("Error", "Image file exceeds the 5MB limit.")
            return
        ...
        try:  
            ...
            messagebox.showerror("Error", "Image size is too large for resizing. Please choose a smaller image.")
...
project_img = Image.open("/temp/Caption Craft Project/Main/AI_Logo.png")
...
predefined_img = Image.open("/temp/Caption Craft Project/Main/No_Image_Available.jpg")
